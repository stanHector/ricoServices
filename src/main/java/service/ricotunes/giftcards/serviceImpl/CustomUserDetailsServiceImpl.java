...
public class CustomUserDetailsServiceImpl implements UserDetailsService, CustomUserDetailsService {
	...
	public UserDetails loadUserByUsername(String usernameOrEmail) {
		Users users = userRepository.findByUsernameOrEmail(usernameOrEmail, usernameOrEmail)
				.orElseThrow(() -> new UsernameNotFoundException(String.format("Users not found with this username or email: %s", usernameOrEmail)));
	...
	public UserDetails loadUserById(Long id) {
		Users users = userRepository.findById(id).orElseThrow(() -> new UsernameNotFoundException(String.format("Users not found with id: %s", id)));
