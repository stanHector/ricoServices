...
public class DefaultController implements ErrorController {
    ...
    @ApiOperation(value = "Link to swagger", notes = "Goto http://localhost:8080/swagger-ui.html", response = String.class)
    public String handleError() {
        return "Goto http://localhost:8080/swagger-ui.html";
    }
